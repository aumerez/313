...
import mintImage from '../../assets/imgs/Illustration_Mint-01_Text2_sm1.png';
  ...
  return (
    <div>
      <div className="mint-page">
        ...
        <div >
          <Image src={mintImage} position='sticky' className='mint-img fixed-bottom d-flex align-items-center justify-content-center text-center'/> 
